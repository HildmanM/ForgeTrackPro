    ...
    <aside className="aside">
      ...
      <nav className="nav" style={{ marginTop: 16, display: "grid", gap: 8 }}>
        ...
        <NavLink to="/jobs" className={({ isActive }) => (isActive ? "active" : undefined)}>
          <Briefcase size={16} /> Jobs <Badge value={counts.jobs} />
        </NavLink>
        <NavLink to="/clients" className={({ isActive }) => (isActive ? "active" : undefined)}>
          <Users size={16} /> Clients <Badge value={counts.clients} />
        </NavLink>
        <NavLink to="/inventory" className={({ isActive }) => (isActive ? "active" : undefined)}>
          <Boxes size={16} /> Inventory <Badge value={counts.inventory} />
        </NavLink>
        <NavLink to="/labor" className={({ isActive }) => (isActive ? "active" : undefined)}>
